export function lcs<T, U>( a: T[], b: U[], compareFunc: (a: T, b: U) => boolean ): number {
  ...
  function getSolution<T, U>(
    a: T[], aStart: number, aEnd: number,
    b: U[], bStart: number, bEnd: number,
    d: number,
  ...
  export default function bestSubSequence<T, U>(
    a: T[], b: U[], compareFunc: (a: T, b: U) => boolean,
    elementsChanged: (type: "add" | "remove" | "same",
                      a: T[], aStart: number, aEnd: number,
                      b: U[], bStart: number, bEnd: number
                     ) => void
